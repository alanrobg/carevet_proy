...
<div class="modal fade" id="update<?=$id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-title">
        ...
        <div class="modal-body">
            <form action="../Procesos/p_servicio.php?data=<?=$encoded_data?>&idservicio=<?=$id?>&accion=update" method="Post" enctype="multipart/form-data">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="input-group mb-3">
                      <label style="flex-basis: 20%" class="input-group-text">Servicio:</label>
                      <input style="flex-basis: 80%" type="text" class="form-control" name="nom_servicio" value="<?=$service?>">
                    </div>
